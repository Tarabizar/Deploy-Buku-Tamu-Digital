                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <button type="submit" name="submit_detail" class="btn btn-primary-custom"><i class="bi bi-save-fill"></i> Simpan Perubahan</button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <button type="submit" name="submit_password" class="btn btn-primary-custom"><i class="bi bi-shield-lock-fill"></i> Ubah Password</button>
                            </form>
                        </div>
                    </div>
                </div>
